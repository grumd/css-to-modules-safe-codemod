...
program
  ...
  .option(
    '--importIdentifier, --import-identifier <importIdentifier>',
    'import identifier to use (import styles from), default: styles',
    'styles'
  )
  .option(
    '--moduleCssPrefix, --module-css-prefix <moduleCssPrefix>',
    'css-module extension suffix (.module.css), default: module',
    'module'
  )
  .action(writeAction);
